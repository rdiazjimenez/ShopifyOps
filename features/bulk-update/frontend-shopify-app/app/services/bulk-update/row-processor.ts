...
import type { BulkUpdateShopifyClient, VariantInput, ProductInput } from "./shopify-client";
...
export async function processRow(row: ParsedRow, client: BulkUpdateShopifyClient): Promise<ProcessedRow> {
  if (row.skipped) {
